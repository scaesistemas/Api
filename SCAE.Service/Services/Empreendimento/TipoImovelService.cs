...
{
    public class TipoImovelService : QueryService<TipoImovel, ITipoImovelRepository>, ITipoImovelService
    {
        public TipoImovelService(ITipoImovelRepository repository) : base(repository)
        {
