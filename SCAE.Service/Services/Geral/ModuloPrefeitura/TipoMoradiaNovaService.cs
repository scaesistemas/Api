...
{
    public class TipoMoradiaNovaService : QueryService<TipoMoradiaNova, ITipoMoradiaNovaRepository>, ITipoMoradiaNovaService
    {
        public TipoMoradiaNovaService(ITipoMoradiaNovaRepository repository) : base(repository)
        {
        }
    }
}
