...
{
    public class TipoInsumoService : QueryService<TipoInsumo, ITipoInsumoRepository>, ITipoInsumoService
    {
        public TipoInsumoService(ITipoInsumoRepository repository) : base(repository)
        {
        }
    }
}
