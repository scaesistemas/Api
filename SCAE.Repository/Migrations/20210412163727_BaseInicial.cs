        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubDominio = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    Responsavel_CodigoZoop = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true),
                    ...
                    Responsavel_DataNascimento = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    Responsavel_Endereco_Bairro = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assinantecontato", x => x.Id);
                    table.ForeignKey(
                        name: "FK_assinantecontato_assinante_AssinanteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assinantedominio", x => x.Id);
                    table.ForeignKey(
                        name: "FK_assinantedominio_assinante_AssinanteId",
                        column: x => x.AssinanteId,
                        principalSchema: "base",
                        principalTable: "assinante",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assinante_Endereco_EstadoId",
                schema: "base",
                table: "assinante",
                column: "Endereco_EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_assinante_Endereco_MunicipioId",
                schema: "base",
                table: "assinante",
                column: "Endereco_MunicipioId");

            migrationBuilder.CreateIndex(
                name: "IX_assinante_Responsavel_Endereco_EstadoId",
                schema: "base",
                table: "assinante",
                column: "Responsavel_Endereco_EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_assinante_Responsavel_Endereco_MunicipioId",
                schema: "base",
                table: "assinante",
                column: "Responsavel_Endereco_MunicipioId");

            migrationBuilder.CreateIndex(
                name: "IX_assinante_SubDominio",
                schema: "base",
                table: "assinante",
                column: "SubDominio",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assinantecontato_AssinanteId",
                schema: "base",
                table: "assinantecontato",
                column: "AssinanteId");

            migrationBuilder.CreateIndex(
                name: "IX_assinantedominio_AssinanteId",
                schema: "base",
                table: "assinantedominio",
                column: "AssinanteId");
